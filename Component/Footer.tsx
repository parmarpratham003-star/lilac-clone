...
export default function Footer() {
  return (
    <footer className="bg-[#f5f1eb] text-black overflow-hidden">
      ...
      <div className="mx-auto max-w-[1400px] px-5 py-10 lg:px-12">
        ...
        <div className="grid gap-10 border-t border-black/10 pt-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-4 max-w-[280px] text-sm leading-6 text-[#6f6f6f] transition duration-300 hover:text-black">
    ...
    >
      Shop
          ...
          <div>
            ...
            <div className="flex overflow-hidden rounded-[3px] border border-black/10 bg-white">
              ...
              <button className="flex h-12 w-14 items-center justify-center bg-[#c9804d] text-white transition duration-300 hover:bg-[#b46f3e]">
      ...
      <div className="border-t border-black/10">
        <div className="mx-auto max-w-[1400px] px-5 py-4 text-center lg:px-12">
          <p className="text-[11px] tracking-[2px] text-[#6f6f6f] transition duration-300 hover:text-black">
